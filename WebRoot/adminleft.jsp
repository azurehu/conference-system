            ...
            <div class="page-sidebar">
                <div class="sidebar-menugroup">
                    ...
                    <ul class="sidebar-menu">
                        <li class="sidebar-menuitem"><a href="MyNotificationServlet" target="main">最新通知</a></li>
                        <li class="sidebar-menuitem active"><a href="ViewMyBookingServlet" target="main">我的预定</a></li>
                        <li class="sidebar-menuitem"><a href="ViewMyMeetingsServlet" target="main" >我的会议</a></li>
                    </ul>
                </div>
                ...
                <div class="sidebar-menugroup">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="sidebar-menuitem"><a href="searchemployees.jsp" target="main" >搜索员工</a></li>
                    </ul>
                </div>
